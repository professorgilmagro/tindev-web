...
export default function Main({ match, location, history }) {
	...
	const showBtnLike = filterBy === undefined || filterBy === 'unlikeds';
	const showBtnUnlike = filterBy === undefined || filterBy === 'likeds';
	return (
				...
				{users.map(user => (
					<li key={user._id}>
						<UserCard
							...
							showButtonLike={showBtnLike}
							showButtonUnlike={showBtnUnlike}
						/>
					</li>
				))}
			</ul>
